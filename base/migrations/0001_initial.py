# Generated by Django 5.0 on 2024-02-16 12:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(default='category.jpg', upload_to='category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(blank=True, default='Second Hand', max_length=100, null=True)),
                ('brand', models.CharField(blank=True, default='Brand Name', max_length=100, null=True)),
                ('model', models.CharField(blank=True, default='Model Name', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='p_images', to='base.product')),
            ],
            options={
